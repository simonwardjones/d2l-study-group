...
\begin{itemize}
   ...
   \item The full notebook where I loaded the data, built an alexnet model and predicted a sample can be explored here: \\ https://colab.research.google.com/github/simonwardjones/d2l-study-group/blob/master/exercises/assignment-7-sw-j.ipynb. \href{https://colab.research.google.com/github/simonwardjones/d2l-study-group/blob/master/exercises/assignment-7-sw-j.ipynb}{Click here for Colab notebook}. 
\end{itemize}
